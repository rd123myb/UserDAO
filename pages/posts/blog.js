    ...
    <Layout>
      <h1>So why is it priced at zero?</h1>
          ...
          <p> UserDAO is a DataDao usecase that gives users the tools they need to generate structured data from the opinions they have about products.
              This data is valuable to companies who use it in thier development process to achieve market fit.
              Currently, this type of high quality data is gathered mostly by either user testing, focus groups or surveys that don't incentivise consumers adequatly. Furthermore, most of this data is siloed within 
          ...
          <p> UserDAO is a decentralized and open-source system for meeting this demand in an open marketplace.
              Specialised surveys and analysis tools are desinged to turn your thoughts and preferences about every aspect of
           ...
           <p>It's obvious that some products are better than others, but the million dollar question is WHY.</p>
           <p>
